...
"""
Machine Learning Interatomic Potentials (MLIP) module for DIMOS.

This module provides integration with various machine learning interatomic potential
frameworks for molecular simulations within the DIMOS framework. It includes:

- MACE: Materials and Chemical Environment models (MaceFoundationalSystem)
- ORB: Orbital Materials models (OrbFoundationalSystem)

Each implementation provides a consistent interface to the respective ML potential
framework, handling unit conversions, periodic boundary conditions, and integration
with DIMOS's simulation capabilities.

Examples
--------
Using MACE potentials:
...
Using ORB potentials:
    system = OrbFoundationalSystem(
        masses=masses,
        atomic_numbers=atomic_numbers,
        orb_name="orb_v2",
        periodic=True,
