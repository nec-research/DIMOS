...
This module provides unit system constants and conversion factors for molecular dynamics
simulations. It supports multiple unit systems including Amber, OpenMM/Gromacs, and
reduced (LJ) units.

The module contains functions to initialize constants in different unit systems and
stores them as module-level variables that can be accessed throughout DIMOS.

Constants include:
    * BOLTZMANN: Boltzmann constant in the chosen unit system
    * ONE_BY_4_PI_EPSILON_0: Coulomb's constant (1/4πε₀) for electrostatic calculations
    * FS_TO_INTERNAL: Conversion factor from femtoseconds to internal time units
    * BAR_TO_INTERNAL_PRESSURE: Conversion factor from bar to internal pressure units
    * eV_to_internal: Conversion factor from electron volts to internal energy units
    * hatree_to_internal: Conversion factor from Hartree to internal energy units
    * internal_to_Angstrom: Conversion factor from internal length units to Angstroms
"""
...
def init_constants_in_unit_system(unit_system='kcal/mol'):
    """
    Initialize constants in the specified unit system.

    This function sets up physical constants and unit conversion factors based on the
    chosen unit system. The constants are stored as module-level variables that can
    be accessed throughout the code.

    Parameters
    ----------
    unit_system : str, optional
        The unit system to use for the constants. Default is 'kcal/mol'.
        Supported unit systems:
            - 'kcal/mol' or 'amber': Amber force field units (energies in kcal/mol)
            - 'kJ/mol' or 'openmm' or 'gromacs': OpenMM/Gromacs units (energies in kJ/mol)
            - 'lj' or 'none' or 'unitless': Reduced (Lennard-Jones) units

    Raises
    ------
    NotImplementedError
        If the specified unit system is not recognized or not implemented.

    Notes
    -----
    The function sets the following module-level constants:
        - BOLTZMANN: Boltzmann constant
        - ONE_BY_4_PI_EPSILON_0: Coulomb's constant for electrostatics
        - FS_TO_INTERNAL: Time unit conversion from femtoseconds
        - BAR_TO_INTERNAL_PRESSURE: Pressure conversion from bar
        - eV_to_internal: Energy conversion from electron volts
        - hatree_to_internal: Energy conversion from Hartree
        - internal_to_Angstrom: Length conversion to Angstroms
    """
    ...
    match unit_system:
        case "kcal/mol" | "amber":
            this.BOLTZMANN = 1.987204259e-3
            this.ONE_BY_4_PI_EPSILON_0 = 332.05575743860264
            this.FS_TO_INTERNAL = 48.88821  # This is the time unit conversion. See: https://docs.lammps.org/2001/units.html
            this.BAR_TO_INTERNAL_PRESSURE = 1.439324095976664e-05  # http://openmopac.net/manual/p=n.html
            this.eV_to_internal = 23.060548012069496
            this.hatree_to_internal = 627.5094738898777
            this.internal_to_Angstrom = 1.0
        case 'kJ/mol' | "openmm" | "gromacs":
            this.BOLTZMANN = 0.00831446261815324  # 1.380649e-23    # J/K
            this.ONE_BY_4_PI_EPSILON_0 = 138.93545764438203547881
            this.FS_TO_INTERNAL = 1.0
            this.BAR_TO_INTERNAL_PRESSURE = 0.0602214076
            this.eV_to_internal = 96.48533288249877
            this.hatree_to_internal = 2625.4996387552483
            this.internal_to_Angstrom = 10.0
        case "lj" | "none" | "unitless":
            this.BOLTZMANN = 1.0
            this.ONE_BY_4_PI_EPSILON_0 = 1.0 / (4 * math.pi)  # TODO: This correct?!
            this.FS_TO_INTERNAL = 1.0
            this.BAR_TO_INTERNAL_PRESSURE = 1.0
            this.eV_to_internal = None  # Units do not make sense here...
            this.hartree_to_internal = None  # Units do not make sense here...
            this.internal_to_Angstrom = None  # Units do not make sense here...
        case _:
            raise NotImplementedError(f"The unit system {unit_system} was not recognized or is not implemented")


# call transform unit with default units to initialize constants in the unit system...
init_constants_in_unit_system()
