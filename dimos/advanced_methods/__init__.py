...
"""
Advanced sampling methods for enhanced molecular dynamics simulations.

This module provides implementations of various advanced sampling techniques
to improve conformational exploration and free energy calculations:

- Replica Exchange (Parallel Tempering): Enhances sampling by exchanging 
  configurations between replicas at different temperatures or between different Hamiltonians
  
- Metadynamics: Accelerates sampling of selected collective variables by 
  adding history-dependent bias potentials

Note: These methods are currently experimental features and should be used
with caution. While they are functionally correct, thorough validation 
against established implementations is recommended.
"""
